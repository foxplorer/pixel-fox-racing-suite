...
export const BarGraphItem = ({ todisplay }: BarGraphProps) => {
...
// for (let p = 0; p < jjj; i++) {
//   if (kkk[i] !== undefined) if(temparray[p].name === kkk[i].origin.data.map.subTypeData.traits[6].value){
...
//     if (bgOptions.includes(tempstring[i].origin.data.map.subTypeData.traits[6].value)) {
//       //do nothing
//     } else {
//       bgOptions.push(tempstring[i].origin.data.map.subTypeData.traits[6].value);
//       //get bgcolors for chart
//       temparray[bgcolorcount] = {name: tempstring[i].origin.data.map.subTypeData.traits[6].value, id: undefined};
//       bgcolorcount ++;
